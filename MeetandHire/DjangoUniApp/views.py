...
#Definimos funciones que devuelven un HTML o servicio de la app
...
#------------------------------------- 
#Insertamos los datos de los postulantes a la base de datos
def insercion_bd_postulante(codpostulante,nombre,apellido,email,fechaNacimiento,nivelEscolar,genero,rut):  #insertamos en postgres los datos de los postulantes
    postulante = Postulante.objects.create(codPostulante=codpostulante,
        nombres=nombre,
        apellidos=apellido,
        email=email,
        fechanamiento=fechaNacimiento,
